...
│
│   └── COVID_Cases_Restricted_Details_02282021.parquet.zip  <- New data file format - Parquet - Files contains 20,565,345 records, 32 fields
│
│
├── python
