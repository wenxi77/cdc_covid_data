...
geometry: "left=1.5cm,right=3cm,top=2cm,bottom=2cm"
output:
...
file_name <- "COVID_Cases_Restricted_Detailed_05102021.parquet"
detailed_file_name = paste(data_dir,"/",file_name,sep="")

#change me to whatever version you want to display
dataset_version <- "2021-05-10"

quasi_identifiers = c("race_ethnicity_combined","sex","age_group","hc_work_yn","res_county","res_state")
...
# [COVID-19 Case Surveillance Restricted Access Detailed Data](https://data.cdc.gov/Case-Surveillance/COVID-19-Case-Surveillance-Restricted-Access-Detai/mbd7-r32t) Utility Summary
